...
if (document.querySelector('.app-cover')) {
	COLOR_SILVER_TRANSPARENT_5 = COLOR_WHITE_TRANSPARENT_2;
	COLOR_SILVER_TRANSPARENT_3 = COLOR_WHITE_TRANSPARENT_2;
	COLOR_SILVER_TRANSPARENT_1 = COLOR_WHITE_TRANSPARENT_1;
	COLOR_WHITE = COLOR_BLACK;
}
if (document.querySelector('.app-header .fab.fa-facebook-square')) {
	COLOR_SILVER_TRANSPARENT_5 = 'rgba(0,0,0,0.1)';
	COLOR_SILVER_TRANSPARENT_3 = 'rgba(0,0,0,0.1)';
}
