		...
		<div class="login login-with-news-feed">
			...
			<div class="news-feed">
				...
				<div class="news-caption">
					...
					<p>
						Look back on the <b>path</b> you have taken in your climbing journey <br>
				...
				<div class="login-content">
					<form v-on:submit.prevent="submit()">
						<div class="form-floating mb-15px">
							<input type="text" class="form-control h-45px fs-13px" placeholder="Email Address" id="emailAddress" v-model="email" />
							<label for="emailAddress" class="d-flex align-items-center fs-13px text-gray-600">Email Address</label>
						</div>
						<div class="form-floating mb-15px">
							<input type="password" class="form-control h-45px fs-13px" placeholder="Password" id="password" v-model="password"/>
